...
coxhb_test_w1 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_test_w1)
...
summary(deno_test_w2$ethnicid_s) ## missing
deno_test_w2_s <- deno_test_w2[complete.cases(deno_test_w2$ethnicid_s),]
summary(deno_test_w2_s$ethnicid_s);levels(deno_test_w2_s$ethnicid_s)

deno_test_w2<- deno_test_w2_s

#Remove comma in category = "African, Caribbean or Black"  to enable .csv export
deno_test_w2$ethnicid_s <- recode_factor(deno_test_w2$ethnicid_s, 'White Scottish'="White Scottish",'White Other British'="White Other British",'White Irish' ="White Irish", 'White Gypsy/Traveller'="White Gypsy/Traveller", 'White Polish'="White Polish",'Other White' ="Other White",                                               "Mixed or multiple ethnic groups"= "Mixed or multiple ethnic groups","Pakistani, Pakistani Scottish or Pakistani British"="Pakistani Pakistani Scottish or Pakistani British", "Indian, Indian Scottish or Indian British"="Indian Indian Scottish or Indian British",                                               "Bangladeshi, Bangladeshi Scottish or Bangladeshi British" ="Bangladeshi Bangladeshi Scottish or Bangladeshi British","Chinese, Chinese Scottish or Chinese British" ="Chinese Chinese Scottish or Chinese British","Other Asian" = "Other Asian",                                               'African' ="African",'Caribbean or Black'="Caribbean or Black", 'Arab, Arab Scottish or Arab British'="Arab Arab Scottish or Arab British",'Other Ethnic Group' ="Other Ethnic Group")
levels(deno_test_w2$ethnicid_s); summary(deno_test_w2$ethnicid_s)
...
coxhb_test_w2 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_test_w2)
...
#==========================================================================================================
#wave 3
summary(deno_test_w3$ethnicid_s) #  missing
deno_test_w3_s <- deno_test_w3[complete.cases(deno_test_w3$ethnicid_s),]
summary(deno_test_w3_s$ethnicid_s);levels(deno_test_w3_s$ethnicid_s)

deno_test_w3<- deno_test_w3_s

#Remove comma in category = "African, Caribbean or Black"  to enable .csv export
deno_test_w3$ethnicid_s <- recode_factor(deno_test_w3$ethnicid_s, 'White Scottish'="White Scottish",'White Other British'="White Other British",'White Irish' ="White Irish", 'White Gypsy/Traveller'="White Gypsy/Traveller", 'White Polish'="White Polish",'Other White' ="Other White",                                               "Mixed or multiple ethnic groups"= "Mixed or multiple ethnic groups","Pakistani, Pakistani Scottish or Pakistani British"="Pakistani Pakistani Scottish or Pakistani British", "Indian, Indian Scottish or Indian British"="Indian Indian Scottish or Indian British",                                               "Bangladeshi, Bangladeshi Scottish or Bangladeshi British" ="Bangladeshi Bangladeshi Scottish or Bangladeshi British","Chinese, Chinese Scottish or Chinese British" ="Chinese Chinese Scottish or Chinese British","Other Asian" = "Other Asian",                                               'African' ="African",'Caribbean or Black'="Caribbean or Black", 'Arab, Arab Scottish or Arab British'="Arab Arab Scottish or Arab British",'Other Ethnic Group' ="Other Ethnic Group")
levels(deno_test_w3$ethnicid_s); summary(deno_test_w3$ethnicid_s)
...
#==============================================
coxhb_test_w3 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_test_w3)
...
summary(deno_test_w4$ethnicid_s) #  missing
deno_test_w4_s <- deno_test_w4[complete.cases(deno_test_w4$ethnicid_s),]
summary(deno_test_w4_s$ethnicid_s);levels(deno_test_w4_s$ethnicid_s)

deno_test_w4<- deno_test_w4_s


#Remove comma in category = "African, Caribbean or Black"  to enable .csv export
deno_test_w4$ethnicid_s <- recode_factor(deno_test_w4$ethnicid_s, 'White Scottish'="White Scottish",'White Other British'="White Other British",'White Irish' ="White Irish", 'White Gypsy/Traveller'="White Gypsy/Traveller", 'White Polish'="White Polish",'Other White' ="Other White",                                               "Mixed or multiple ethnic groups"= "Mixed or multiple ethnic groups","Pakistani, Pakistani Scottish or Pakistani British"="Pakistani Pakistani Scottish or Pakistani British", "Indian, Indian Scottish or Indian British"="Indian Indian Scottish or Indian British",                                               "Bangladeshi, Bangladeshi Scottish or Bangladeshi British" ="Bangladeshi Bangladeshi Scottish or Bangladeshi British","Chinese, Chinese Scottish or Chinese British" ="Chinese Chinese Scottish or Chinese British","Other Asian" = "Other Asian",                                               'African' ="African",'Caribbean or Black'="Caribbean or Black", 'Arab, Arab Scottish or Arab British'="Arab Arab Scottish or Arab British",'Other Ethnic Group' ="Other Ethnic Group")
levels(deno_test_w4$ethnicid_s); summary(deno_test_w4$ethnicid_s)
...
#=========================================================
coxhb_test_w4 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_test_w4)
...
deno_test_w1 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex, data = deno_test_w1)
...
#Wave 2
deno_test_w2 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex, data = deno_test_w2)
...
#Wave 3
deno_test_w3 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex, data = deno_test_w3)
...
#Wave 4
deno_test_w4 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s + age_5y + sex, data = deno_test_w4)
...
deno_test_w1 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s, data = deno_test_w1)
summary(deno_test_w1)
#export output
deno_test_w1_out<- capture.output(publish(deno_test_w1, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",deno_test_w1_out)),collapse="\n"),file="deno_test_w1_out.csv")
...
#Wave 2
deno_test_w2 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s , data = deno_test_w2)
summary(deno_test_w2)
#export output
deno_test_w2_out<- capture.output(publish(deno_test_w2, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",deno_test_w2_out)),collapse="\n"),file="deno_test_w2_out.csv")
...
#Wave 3
deno_test_w3 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s , data = deno_test_w3)
summary(deno_test_w3)
#export output
deno_test_w3_out<- capture.output(publish(deno_test_w3, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",deno_test_w3_out)),collapse="\n"),file="deno_test_w3_out.csv")
...
#Wave 4
deno_test_w4 <- coxph(Surv(covidtest_fu, covidtest_event) ~ ethnicid_s , data = deno_test_w4)
summary(deno_test_w4)
#export output
deno_test_w4_out<- capture.output(publish(deno_test_w4, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",deno_test_w4_out)),collapse="\n"),file="deno_test_w4_out.csv")
...
#=========================================
coxhb_hosp_w1 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_hosp_w1)
...
#wave 2
summary(deno_hosp_w2$ethnicid_s) ## missing
...
#============================================
coxhb_hosp_w2 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_hosp_w2)
...
summary(deno_hosp_w3$ethnicid_s) ## missing
...
#=========================
coxhb_hosp_w3 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_hosp_w3)
...
#===================================
coxhb_hosp_w4 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex + hb2019, data = deno_hosp_w4)
...
#=========================================
coxhb_hosp_w1 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex, data = deno_hosp_w1)
summary(coxhb_hosp_w1)
#export output
coxhb_hosp_w1_out<- capture.output(publish(coxhb_hosp_w1, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w1_out)),collapse="\n"),file="coxhb_hosp_w1_out.csv")
...
#Wave 2
coxhb_hosp_w2 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex, data = deno_hosp_w2)
summary(coxhb_hosp_w2)
#export output
coxhb_hosp_w2_out<- capture.output(publish(coxhb_hosp_w2, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w2_out)),collapse="\n"),file="coxhb_hosp_w2_out.csv")
...
#Wave 3
coxhb_hosp_w3 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex, data = deno_hosp_w3)
summary(coxhb_hosp_w3)
#export output
coxhb_hosp_w3_out<- capture.output(publish(coxhb_hosp_w3, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w3_out)),collapse="\n"),file="coxhb_hosp_w3_out.csv")
...
#Wave 4
coxhb_hosp_w4 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s + age_5y + sex, data = deno_hosp_w4)
summary(coxhb_hosp_w4)
#export output
coxhb_hosp_w4_out<- capture.output(publish(coxhb_hosp_w4, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w4_out)),collapse="\n"),file="coxhb_hosp_w4_out.csv")
...
#=========================================
coxhb_hosp_w1 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s , data = deno_hosp_w1)
summary(coxhb_hosp_w1)
#export output
coxhb_hosp_w1_out<- capture.output(publish(coxhb_hosp_w1, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w1_out)),collapse="\n"),file="coxhb_hosp_w1_out.csv")
...
#Wave 2
coxhb_hosp_w2 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s , data = deno_hosp_w2)
summary(coxhb_hosp_w2)
#export output
coxhb_hosp_w2_out<- capture.output(publish(coxhb_hosp_w2, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w2_out)),collapse="\n"),file="coxhb_hosp_w2_out.csv")
...
#Wave 3
coxhb_hosp_w3 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s , data = deno_hosp_w3)
summary(coxhb_hosp_w3)
#export output
coxhb_hosp_w3_out<- capture.output(publish(coxhb_hosp_w3, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w3_out)),collapse="\n"),file="coxhb_hosp_w3_out.csv")
...
#Wave 4
coxhb_hosp_w4 <- coxph(Surv(covidhosp_fu, covidhosp_event) ~ ethnicid_s , data = deno_hosp_w4)
summary(coxhb_hosp_w4)
#export output
coxhb_hosp_w4_out<- capture.output(publish(coxhb_hosp_w4, org=TRUE))
cat(paste(gsub("^,|,$","",gsub("[|]",",",coxhb_hosp_w4_out)),collapse="\n"),file="coxhb_hosp_w4_out.csv")
...
#=====================================================================================================================
#wave 2
summary(deno_death_w2$ethnicid_s) #  missing
...
#============================================================================
#wave 3
summary(deno_death_w3$ethnicid_s) ## missing
...
#wave 4
summary(deno_death_w4$ethnicid_s) ## missing
...
#data management 
#================================================================
summary(deno_hosdea_w1$ethnicid_s) ## missing
...
#======================================================================================================
#wave 2
summary(deno_hosdea_w2$ethnicid_s) ## missing
...
#========================================================================================
#wave 3
summary(deno_hosdea_w3$ethnicid_s) # missing
...
#wave 4
summary(deno_hosdea_w4$ethnicid_s) #  missing
