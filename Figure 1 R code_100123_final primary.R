...
data_full_d<-read.csv("N:/Mediation analysis/outcomes paper/forest_plots/primary covid19_ethnic_disaggr_10012023.csv",stringsAsFactors = F)
str(data_full_d)
...
grid.arrange(p1,p2,p3,p4,p5,p6,p1_death,p2_death,p3_death,layout_matrix = lay2)
 
 p_testf6<-grid.arrange(p1,p2,p3,p4,p5,p6,p1_death,p2_death,p3_death,layout_matrix = lay2)


ggsave(file="Primary Figure s1_30Jan23.pdf", p_testf6,width = 14.5,height =16,dpi=1000)
