...
##
##Description: merge covid outcome data together with denominator - BY WAVE
##################################################
rm(list=ls())
#Libraries
...
load(file = "covidtest_event1.RData")
load(file = "smr01_event2.RData")
load(file = "nrsdeath_event2.RData")

#prognosis data (before deduplication)
...
#merge denominator
deno_nrs <- left_join(denominator4, nrsdeath2, by = "ID") #s
#skim(deno_nrs) 
...
smr01_wave <- smr01_event1 %>%
  select(ID:covidhosp_a, wave_hosp, covidhosp_inf:covidhosp_event)

nrsdeath_event3 <- nrsdeath_event2 %>%
  select(ID:coviddeath_a, coviddeath_inf:coviddeath_event) %>%
  mutate(death = 1)
##############################################################################
...
table(deno_hosdea_w1$covidhosdea_event) #6819   
table(deno_hosdea_w2$covidhosdea_event) #14509   
table(deno_hosdea_w3$covidhosdea_event) #10163      
table(deno_hosdea_w4$covidhosdea_event) #13707   
...
##############################################################################
setwd("//Farr-FS1/Study Data/2021-0115/Research/Kibuchi/Sarah/Results/Covid outcomes/Raw/Waves")
#wave 1
...
save(deno_test_w1, file = "deno_test_w1.RData")
save(deno_test_w2, file = "deno_test_w2.RData")
save(deno_test_w3, file = "deno_test_w3.RData")
save(deno_test_w4, file = "deno_test_w4.RData")

save(deno_hosp_w1, file = "deno_hosp_w1.RData")
save(deno_hosp_w2, file = "deno_hosp_w2.RData")
save(deno_hosp_w3, file = "deno_hosp_w3.RData")
save(deno_hosp_w4, file = "deno_hosp_w4.RData")

save(deno_death_w1, file = "deno_death_w1.RData")
save(deno_death_w2, file = "deno_death_w2.RData")
save(deno_death_w3, file = "deno_death_w3.RData")
save(deno_death_w4, file = "deno_death_w4.RData")

save(deno_hosdea_w1, file = "deno_hosdea_w1.RData")
save(deno_hosdea_w2, file = "deno_hosdea_w2.RData")
save(deno_hosdea_w3, file = "deno_hosdea_w3.RData")
save(deno_hosdea_w4, file = "deno_hosdea_w4.RData")
