...
data_full_d<-read.csv("N:/Mediation analysis/outcomes paper/forest_plots/primary_covid19_ethnic_disaggr_09012023_post.csv",stringsAsFactors = F)
str(data_full_d)
...
ggsave(file="Figure s2_300123.pdf", p_testf6,width = 14.5,height =16, dpi=1000)
